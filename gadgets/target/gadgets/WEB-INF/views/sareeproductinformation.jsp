...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
  <title>Women Collection Store</title>
		...
		<div class="item-container">	
			<div class="container">	
				<div class="col-md-12">
                    ...
                    <br>
						<center>
							<!-- <img id="item-display" src="./resources/images/fig1.jpg" alt="" width="40%" height="30%"></img> -->
							<img id="item-display" src="./resources/images/fig1.jpg" alt="" width="150" height="150"></img>
						</center>
					</div>
				...
				<div class="col-md-7">
				<div class="product-title">Dress Collection </div>
