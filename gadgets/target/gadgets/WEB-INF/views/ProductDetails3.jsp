		...
		<div class="item-container">	
			<div class="container">	
				<div class="col-md-12">
                    ...
                    <br>
						<center>
							<!-- <img id="item-display" src="./resources/images/1.jpg" alt="" width="40%" height="30%"></img> -->
							<img id="item-display" src="./resources/images/w1.jpg" alt="" width="150" height="150"></img>
						</center>
					</div>
				...
				<div class="col-md-7">
				<div class="product-title">Sues Collection </div>
