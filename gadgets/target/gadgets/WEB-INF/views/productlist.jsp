               ...
               <table class="table table-striped table-bordered table-list">
                 ...
                 <tbody>
                         ...
                         <td>
                           ...
                           <td class="hidden-xs" style="color:white;">${p.p_id }</td>
                           <td style="color:white;">${p.p_name }</td>
                           <td style="color:white;">${p. p_price}</td>
                           <td style="color:white;">${p.category.c_name}</td>     
                           <td style="color:white;">${p.supplier.s_name}</td>         
                            
                           <td style="color:white;"><a href="product?id=${p.p_id}"><img src="${pageContext.request.contextPath}/resources/images/product/${p.p_image}"  class="img-rounded" alt="${p.p_name }" width="75px" height="50px"/></a></td>         
                           </tr>       
                         </c:forEach>
                       </tbody>
               </table>
